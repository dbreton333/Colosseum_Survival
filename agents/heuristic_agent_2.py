...
@register_agent("heuristic_agent_2")
class HeuristicAgent2(Agent):
    ...
    def __init__(self):
        super(HeuristicAgent2, self).__init__()
        self.name = "heuristic_agent_2"
        self.dir_map = {
            "u": 0,
            "r": 1,
            "d": 2,
    ...
    def step(self, chess_board, my_pos, adv_pos, max_step):
        ...
        self.my_move_count = self.count_all_moves(my_pos, adv_pos)
    ...
    def generate_all_moves_bfs(self,my_pos, adv_pos, all_moves):
    ...
    def generate_all_max_moves_bfs(self,my_pos, adv_pos, all_moves):
        ...
        while queue:
            ...
            if steps_remaining == 0 or len(allowed_dirs) == 0: #If no more possible moves, add to all moves
                for barrier_dir in allowed_barriers:
                    potential_move = (current_pos, barrier_dir)
                    all_moves.append(potential_move)
                continue
    ...
    def get_current_moves(self,my_pos, adv_pos, moves):
        if self.end_game:
            self.generate_all_moves_bfs(my_pos, adv_pos, moves)
        else:
            self.generate_all_max_moves_bfs(my_pos, adv_pos, moves)
    ...
    def alpha_beta(self,my_pos, adv_pos, depth):  
        ...
        if self.my_move_count <= 60:
            self.generate_all_moves_bfs(my_pos, adv_pos, moves_max)
        else:
    ...
    def minValue(self, my_pos, adv_pos, depth, alpha, beta):
        ...
        self.get_current_moves(adv_pos, my_pos, moves_min)
    ...
    def count_max_moves(self,my_pos, adv_pos):
        ...
        while queue:
            ...
            if steps_remaining == 0:
                move_count += len(allowed_barriers)
                continue
    ...
    def evaluate_position(self,my_pos, adv_pos):
        ...
        move_count =self.count_max_moves(my_pos, adv_pos)
